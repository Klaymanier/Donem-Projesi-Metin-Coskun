...
CREATE TABLE IF NOT EXISTS `sepet_ogeleri` (
...
CREATE TABLE IF NOT EXISTS `siparisler` (
  ...
  `siparis_durumu` enum('beklemede','onaylandi','hazirlaniyor','kargoya_verildi','tamamlandi','iptal_edildi') COLLATE utf8mb4_turkish_ci DEFAULT 'beklemede',
  `odeme_yontemi` varchar(50) COLLATE utf8mb4_turkish_ci NOT NULL,
  `odeme_durumu` enum('beklemede','onaylandi','iptal_edildi','iade_edildi') COLLATE utf8mb4_turkish_ci DEFAULT 'beklemede',
...
CREATE TABLE IF NOT EXISTS `urun_varyasyonlari` (
